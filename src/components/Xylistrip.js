                                            ...
                                            <div className="flex-viewport" style={{ overflow: 'hidden', position: 'relative', height: viewportHeight }}>
                                                <div className="woocommerce-product-gallery__wrapper" style={{ width: '800%', transitionDuration: '0s', transform: 'translate3d(0px, 0px, 0px)' }}>
                                                    ...
                                                    {activeImage === '/img/xylitol-video-thumbnail.png' && (
                                                        <div className={`woocommerce-product-gallery__image ${activeImage ? 'flex-active-slide' : ''}`} style={{ width: imageWidth, marginRight: '0px', float: 'left', display: 'block', overflow: 'hidden' }}>
                                                            <>
                                                                <img
                                                                    width={600}
                                                                    height={400}
                                                                    src="/img/Xylitol-Thumbnail.png"
                                                                    className="wp-post-image"
                                                                    alt="Xylistrip Video"
                                                    ...
                                                    <li key={index} className={path === '/img/xylitol-video-thumbnail.png' ? 'wpcpv-thumb-video' : ''}>
                                                        ...
                                                        {path === '/img/xylitol-video-thumbnail.png' && (
                                                            <span className="wpcpv-item wpcpv-item-video my-class" data-src="https://youtu.be/cwsvZL-eMU8">
                                                                <img width="899" height="600" src="/img/Xylitol-Video-Thumbnail.png" className='zoomImg' alt="video" />
                                                            </span>
                                                        )}
                                                    </li>
                                                ))}
                                        ...
                                        <div className="summary entry-summary">
                                            ...
                                            <div className="woocommerce-product-details__short-description">
                                                ...
                                                <p style={{ overflow: 'visible' }}>
                                                    <Link href="https://www.henryschein.ca/ca-en/Shopping/Products.aspx?productid=9401174,9401175" id="btn-add-to-cart" rel="noopener" target="_blank">Buy Now</Link>
                                                </p>
                                            </div>
